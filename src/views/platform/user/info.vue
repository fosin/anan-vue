        ...
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('cdp_sys_user.oldPassword.label')" prop="password" label-width="200px">
              <el-input v-model="userInfo2.password" :placeholder="$t('cdp_sys_user.oldPassword.placeholder')" type="password" auto-complete="off"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('cdp_sys_user.confirmPassword1.label')" prop="confirmPassword1" label-width="200px">
              <el-input :placeholder="$t('cdp_sys_user.confirmPassword1.placeholder')" v-model="userInfo2.confirmPassword1" type="password" auto-complete="off"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item :label="$t('cdp_sys_user.confirmPassword2.label')" prop="confirmPassword2" label-width="200px">
              <el-input v-model="userInfo2.confirmPassword2" :placeholder="$t('cdp_sys_user.confirmPassword2.placeholder')" type="password" auto-complete="off"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
