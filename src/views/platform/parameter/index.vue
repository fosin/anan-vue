  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-button-group>
        ...
        <el-button round v-waves type="danger" v-permission="'55'" class="filter-item" style="margin-left: 5px;"
                   icon="el-icon-delete" @click="handleDelete()">{{$t('table.delete')}}
        </el-button>
        <el-button round v-waves type="warning" v-permission="'56'" class="filter-item" style="margin-left: 5px;"
                   icon="el-icon-upload" @click="handleApply()">{{$t('table.apply')}}
        </el-button>
        <el-button round v-waves type="warning" v-permission="'57'" class="filter-item" style="margin-left: 5px;"
