      ...
      <el-col :span="16" style="margin-top:15px;">
        <el-card class="box-card">
          <el-form ref="form" :label-position="labelPosition" :model="form" :rules="formRules" label-width="100px">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item :label="$t('cdp_sys_permission.appName.label')" prop="appName">
                  <el-select v-model="form.appName" :disabled="formUpdate?formUpdate:parent.level !== 0" :placeholder="$t('cdp_sys_permission.appName.placeholder')" class="filter-item" value="">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item :label="$t('cdp_sys_permission.name.label')" prop="name">
                  <el-input v-model="form.name" :disabled="formUpdate" :placeholder="$t('cdp_sys_permission.name.placeholder')"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="$t('cdp_sys_permission.code.label')" prop="code">
                  <el-input v-model="form.code" :disabled="formUpdate" :placeholder="$t('cdp_sys_permission.code.placeholder')"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item :label="$t('cdp_sys_permission.url.label')" prop="url">
              <el-input v-model="form.url" :disabled="formUpdate" :placeholder="$t('cdp_sys_permission.url.placeholder')"/>
            </el-form-item>

            <el-form-item :label="$t('cdp_sys_permission.path.label')" prop="path" >
              <el-input v-model="form.path" :disabled="formUpdate" :placeholder="$t('cdp_sys_permission.path.placeholder')"/>
            </el-form-item>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item :label="$t('cdp_sys_permission.type.label')" prop="type">
                      <el-select v-model="form.type" :disabled="formUpdate" :placeholder="$t('cdp_sys_permission.type.placeholder')" class="filter-item" >
                  ...
                  <el-col :span="6">
                    <el-form-item :label="$t('cdp_sys_permission.sort.label')" prop="sort">
                      <el-input v-model="form.sort" :disabled="formUpdate" :placeholder="$t('cdp_sys_permission.sort.placeholder')"/>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-col>
            ...
            <el-form-item :label="$t('cdp_sys_permission.status.label')" prop="status">
              <el-switch
                :disabled="formUpdate"
                v-model="form.status"
                active-color="#13ce66"
