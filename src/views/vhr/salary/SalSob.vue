  ...
  <div>
    <el-container>
      <el-header style="display: flex;justify-content: space-between;align-items: center;padding-left: 0px">
        ...
        <el-button size="mini" type="success" icon="el-icon-refresh" @click="loadSalaryCfg" />
      </el-header>
      <el-main style="padding-left: 0px;padding-top: 0px">
        ...
        <div v-if="salaries!==0" style="text-align: left;margin-top: 10px">
    ...
    <div style="text-align: left">
      ...
      >
        ...
        <div style="display: flex;align-items: center;justify-content: center;padding: 0px;margin: 0px;">
          <el-button v-if="index!==0" round size="mini" @click="index--">
            上一步
          </el-button>
          <el-button type="primary" round size="mini" @click="next" v-text="index===7?'完成':'下一步'" />
        </div>
      </el-dialog>
    </div>
  </div>
