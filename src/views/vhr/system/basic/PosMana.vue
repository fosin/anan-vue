<template>
  <div>
    <div style="text-align: left">
      ...
      />
      <el-select v-if="state==='jobtitle'" v-model="titleLevel" size="mini" placeholder="职称等级">
        <el-option
      ...
      <el-button type="primary" icon="el-icon-plus" size="mini" @click="addPosition">
        添加
      </el-button>
    </div>
    ...
    <div style="text-align: left">
      <el-dialog
        ...
        width="25%"
      >
        <el-input v-model="updatePosName" size="mini" placeholder="请输入新的职位名称..." />
        <el-select
          v-if="state==='jobtitle'"
