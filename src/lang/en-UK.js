export default {
  route: {
    ...
    Config: 'Config',
    ConfigApplication: 'App Config',
    ConfigParameter: 'Parameter Config',
    ConfigDictionary: 'Dictionary Config',
    Monitor: 'Monitor',
    MonitorEureka: 'Eureka Monitor',
    MonitorAdmin: 'Admin Monitor',
    MonitorSleuth: 'Sleuth Monitor',
    MonitorCache: 'Cache Manager',
    MonitorElk: 'Log Manager',
