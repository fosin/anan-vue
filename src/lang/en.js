export default {
  route: {
    ...
    development_permission: 'Permission Manage',
    development_swaggerDoc: 'Dev Domcument',
    development_version: 'Version Manage',
    development_versionRole: 'Version Role Manage',
    development_authClient: 'Client Authentication',
    config: 'Config',
